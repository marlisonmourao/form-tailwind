...
import { UploadCloud } from '../../../../node_modules/lucide-react'
...
export function Trigger() {
  ...
  return (
    ...
    >
      <div className="borde-6 rounded-full border-zinc-50 bg-zinc-100 p-2 group-hover:border-violet-50 group-hover:bg-violet-100">
